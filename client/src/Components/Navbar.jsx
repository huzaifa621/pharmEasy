...
import { Input, InputGroup, InputRightAddon,InputRightElement,Select } from "@chakra-ui/react";
      ...
      <div>
        <div>
          <InputGroup width={"80%"}>
            ...
            <Input placeholder="Seach medicines/Healthcare product" bg="white" size="lg" />
