...
const Myrefills = () => {
  return (
    ...
    <Box w={'60%'} mr='2rem'  border='0.5px' boxShadow='2xl' p='6' rounded='md' bg='white'>
    <Box p={'1rem'} >
    <Text fontSize={'2xl'} fontWeight='bold'> BENEFITS OF REFILL</Text>
   <Divider m={'2rem'}/>
   <Box display ='flex' w={'100%'} h='11rem'>
    <Box  w={'50%'} h='11rem'>
        <Image src='https://assets.pharmeasy.in/web-assets/mailer/easy-return.png' />
        <Heading as={'h6'} size='sm' m={'-2rem 0rem 0rem 7rem'}>Easy Returns</Heading>
        <Text size='sm' m={'0.5rem 0rem 0rem 7rem'}>Return your medicine within 30 days and healthcare products within 2 days</Text>
    </Box>
    <Box  w={'50%'} h='11rem'>
        <Image src='https://assets.pharmeasy.in/web-assets/mailer/auto-reminder.png' />
        <Heading as={'h6'} size='sm' m={'-2rem 0rem 0rem 7rem'}>Auto reminders</Heading>
        <Text size='sm' m={'0.5rem 0rem 0rem 7rem'}>We remind you before your items get over</Text>
    </Box>
   </Box>
   <Box display ='flex' w={'100%'} h='11rem'>
    <Box  w={'50%'} h='11rem'>
        <Image src='https://assets.pharmeasy.in/web-assets/mailer/easy-cancel.png' />
        <Heading as={'h6'} size='sm' m={'-2rem 0rem 0rem 7rem'}>Easy cancellation</Heading>
        <Text size='sm' m={'0.5rem 0rem 0rem 7rem'}>You can cancel or skip any of your refill order</Text>
    </Box>
    <Box  w={'50%'} h='11rem'>
        <Image src='https://assets.pharmeasy.in/web-assets/mailer/schedule-delivery.png' />
        <Heading as={'h6'} size='sm' m={'-2rem 0rem 0rem 7rem'}>Scheduled deliveries</Heading>
        <Text size='sm' m={'0.5rem 0rem 0rem 7rem'}>We deliver as per your requested date</Text>
    </Box>
   </Box>
   ...
   <Box w={'33%'} h='11rem'  boxShadow='2xl' p='6' rounded='md' bg='white'>
    ...
    <Text fontSize={'1xl'} fontWeight='bold' justifySelf={'left'}>A HASSLE FREE EXPERIENCE</Text>
    <Text size='md' m='4rem 0rem 0rem -8rem'>This feature has been disabled. We will be back with a new and improved feature soon!</Text>
    </Box>
        </Box>
 </Box>
  <Divider m={'5rem'}/>
