...
import { Box, Grid, Heading, Image, Text,ListItem, UnorderedList, Divider } from "@chakra-ui/react";
...
const Healthcare = ({ slides }) => {
  ...
  return (
    <>
      ...
      <Box w="80%" m="auto">
        <Grid templateColumns="repeat(3, 1fr)" gap={9}>
          <Box
            ...
            onClick={()=>getData("Covid Essentials")}
          >
            <Image
          ...
          <Box
            ...
            boxShadow="md"
            _hover={{ borderColor: "skyblue", borderWidth: "5px" }}
            onClick={()=>getData("Health Food and Drinks")}
          >
            <Image
          ...
          <Box
            ...
            boxShadow="md"
            _hover={{ borderColor: "skyblue", borderWidth: "5px" }}
            onClick={()=>getData("Ayurvedic Care")}
          >
            <Image
          ...
          <Box
            ...
            boxShadow="md"
            _hover={{ borderColor: "skyblue", borderWidth: "5px" }}
            onClick={()=>getData("Sexual Wellness")}
          >
            <Image
      ...
      <Heading as='h4' size='sm' ml={"7rem"} mt='1rem'>Our most popular categories:</Heading>
      <Text justifyContent={'center'} textAlign='left' m='0.5rem 7rem 1rem 7rem'>We have a range of categories and products, some which are:</Text>

      <Heading as='h4' size='sm' ml={"7rem"} mt='1.0rem'>Devices</Heading>
      <Text justifyContent={'center'} textAlign='left' m='0.5rem 7rem 1rem 7rem'>With the pandemic upending our lives, we have all realized that there are some medical devices that we need to keep in our homes such as Oximeter, Thermometer, Inhaler, Blood pressure monitor, Glucometer.</Text>

      <Heading as='h4' size='sm' ml={"7rem"} mt='1rem'>Personal care</Heading>
      <Text justifyContent={'center'} textAlign='left' m='0.5rem 7rem 1rem 7rem'>Personal care products can include a wide range of products such as Bath products, , Skincare essentials, Razor blades, Toothpaste and toothbrush, Wet wipes, Lip balm, Face masks, Hand sanitizer, etc.</Text>

      <Heading as='h4' size='sm' ml={"7rem"} mt='1rem'>Nutrition and fitness supplements</Heading>
      <Text justifyContent={'center'} textAlign='left' m='0.5rem 7rem 1rem 7rem'>To give your health a helping hand, you can order a wide variety of health supplements including Health drinks, Nutritional powder, Nutrition tablets/capsules.</Text>

      <Heading as='h4' size='sm' ml={"7rem"} mt='1.0rem'>Ayurvedic care</Heading>
      <Text justifyContent={'center'} textAlign='left' m='0.5rem 7rem 1rem 7rem'>Place your trust in the goodness of natural and organic ayurvedic products for an all-around healthy mind and body. There’s plenty to choose from such as Aloe vera juice, Moringa capsules, Garlic capsules.</Text>

      <Heading as='h4' size='sm' ml={"7rem"} mt='1rem'>Home care</Heading>
      <Text justifyContent={'center'} textAlign='left' m='0.5rem 7rem 1rem 7rem'>Home care products are things you need every day such as disinfectant spray, phenyl, dishwashing liquid, etc. Get them all at spectacular discounts on PharmEasy.</Text>

      <Heading as='h4' size='sm' ml={"7rem"} mt='1rem'>Baby and mom care</Heading>
      <Text justifyContent={'center'} textAlign='left' m='0.5rem 7rem 1rem 7rem'>PharmEasy also has an impressive range of baby and mom care products including Diapers, Baby bath products, Infant formula food, Mother’s health drinks, Diaper rash creams, Baby wipes.</Text>

      <Heading as='h4' size='sm' ml={"7rem"} mt='1.0rem'>Our top brands:</Heading>
      <Text justifyContent={'center'} textAlign='left' m='0.5rem 7rem 1rem 7rem'>Get products from the most famous and trusted brands including Accu-chek, Dettol, Horlicks, Baidyanath, Sebamed.</Text>

      <Heading as='h4' size='sm' ml={"7rem"} mt='1rem'>You are safe with PharmEasy:</Heading>
      <Text justifyContent={'center'} textAlign='left' m='0.5rem 7rem 1rem 7rem'>Given the times, we are taking all precautions to ensure that we keep everyone safe - our customers and the people we work with.</Text>

      <Heading as='h4' size='sm' ml={"7rem"} mt='1rem'>We ensure</Heading>
      <UnorderedList m={"0.5rem 9rem 0rem 8rem"}>
      <ListItem>Regular sanitization of our premises and warehouses</ListItem>
      <ListItem>Temperature checks of our employees and delivery partners</ListItem>
      <ListItem>No-contact door-step delivery</ListItem>
      <ListItem>Sanitized packaging</ListItem>
      </UnorderedList>

      <Heading as='h4' size='sm' ml={"7rem"} mt='1rem'>Youe safety is our priority</Heading>
      <Text justifyContent={'center'} textAlign='left' m='0.5rem 7rem 7rem 7rem'>Stay safe at home and shop at your convenience from PharmEasy. All you have to do is place your order and we will try to deliver it at the earliest.</Text>
